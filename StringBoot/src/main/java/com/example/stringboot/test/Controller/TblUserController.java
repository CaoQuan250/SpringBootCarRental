//package com.example.stringboot.test.Controller;
//
//import com.example.stringboot.test.model.TblUser;
//import com.example.stringboot.test.service.TblUserService;
//
...
//        Optional<TblUser> _olderUser = tblUserService.findUserById(id);
//        if (_olderUser == null){
//            return ResponseEntity.notFound().build();
//        } else {
